...
![Redfish dashboard against a real OpenBMC bmcweb](docs/screenshots/dashboard.png)
...
|                                                                                           |                                                         |
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| ![Login screen](docs/screenshots/login.png)                                               | ![Dashboard at rest](docs/screenshots/dashboard.png)    |
| _Login (Redfish `SessionService`)._                                                       | _Dashboard at rest._                                    |
